...
示例：
python demo_infer_one_state.py \
...
python demo_infer_one_state.py --ckpt ... --data-dir ... --joint-key 842
"""
import os
import json
import math
...
# ===== 你的模型（与 export 一致）=====
# 按你的工程实际情况导入（export_test_all_states_ply.py 中使用的是 VisModelingModel.load_from_checkpoint）。
